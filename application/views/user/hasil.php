        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    ?>
                    <li
                    class="<?= (isset($all) && $all == 'home') ? 'active' : '' ?>"></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <a href="<?= base_url('user/product/detail/' . $prd['id_product']) ?>">
                            <div class="product">
                                <div class="productt-img">
                                    <img src="<?php echo base_url() ?>assets/upload/<?= $prd['picture'] ?>"
                                        class="responsivee-img" alt="">
                                </div>

                                <div class="product-body">
                                    <p class="product-category"><?= $prd['kategori'] ?></p>
                                    <h3 class="product-name"><a href="#"><?= $prd['nama'] ?></a></h3>
                                    <h4 class="product-price">Rp <?= number_format($prd['harga'], 0, ',', '.') ?></h4>
                                </div>
                            </div>
                        </a>
                    </div>
