			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a class="btn btn-outline-success m-1" href="<?= base_url('admin/transaksi/order/ubah_menuju_alamat/' . $t['id_transaction']) ?>">
							Ubah ke Pesanan Dalam Perjalanan Menuju Alamat
						</a>
					</div>
				</div>
			</div>
