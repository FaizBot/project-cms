                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    ...
                                    <td>
										...
										<a onClick="confirmDeletePesanan('<?= $t['id_transaction']; ?>')" class="me-2">
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a class="btn btn-outline-success m-1" href="<?= base_url('admin/transaksi/order/ubah_konfirmasi/' . $t['id_transaction']) ?>">
							Ubah ke Pesanan Dikonfirmasi
						</a>
					</div>
				</div>
			</div>
