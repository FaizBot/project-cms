				        ...
				        <table id="myTable" class="table table-bordered"
                            ...
                            <thead>
                                <tr role="row">
                                    ...
                                    <th style="width: 150.4583px;">Status</th>
		...
		<div class="modal fade" id="detailsModal<?= $t['id_transaction']; ?>" tabindex="-1"
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
                    ...
                    <form action="<?= base_url('admin/transaksi/order/ubah_dikirim/' . $t['id_transaction']) ?>" method="post">
                        <!-- Modal Body -->
                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="mb-3">
                                                        <label for="usernameLeft" class="form-label">No Resi</label>
                                                        <input type="text" class="form-control" id="usernameLeft" name="no_resi" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
